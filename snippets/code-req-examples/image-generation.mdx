...
request.Content = new StringContent("{\"prompt\":\"A beautiful sunset over a calm ocean\",\"return_type\":\"url\"}");
...
string responseBody = await response.Content.ReadAsStringAsync();
    ...
    ```json Response
{
      "url": "https://jigsawstack-temp.b1e91a466694ad4af04df5d05ca12d93.r2.cloudflarestorage.com/temp/cfd71415-9f3e-46dd-a004-28325cb23d2f.png?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=7b9a19349842b7b1a9e4c2e19f05b232%2F20250820%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250820T195214Z&X-Amz-Expires=604800&X-Amz-Signature=4e28a61cce218731708f28fd8246ad841af1ddb52de41d2bcd1412fe1dc087ac&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject",
      "_usage": {
            "input_tokens": 18,
            "output_tokens": 75,
            "inference_time_tokens": 1843,
            "total_tokens": 1936
      }
}
    ```
