    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the freestanding bell tower of Pisa Cathedral and the third-oldest structure in the city's Cathedral Square.",
            "The tower's tilt started in the 12th century due to a weak foundation on soft ground, increasing until stabilization efforts in the late 20th/early 21st centuries.",
            "The tower is approximately 55.86-56.67 meters tall, with walls 2.44 meters thick at the base, weighing an estimated 14,500 tonnes, and has 294 or 296 steps."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 124,
            "inference_time_tokens": 1442,
            "total_tokens": 1822
      }
}
    ```
