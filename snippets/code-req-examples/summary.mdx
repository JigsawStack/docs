    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the freestanding bell tower of Pisa Cathedral, located behind the Cathedral in Cathedral Square.",
            "The tower's tilt started in the 12th century due to a weak foundation on soft ground, increasing until stabilization efforts in the late 20th and early 21st centuries.",
            "The tower is approximately 55.86-56.67 meters tall, weighs an estimated 14,500 tonnes, and has either 296 or 294 steps."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 112,
            "inference_time_tokens": 1711,
            "total_tokens": 2079
      }
}
    ```
