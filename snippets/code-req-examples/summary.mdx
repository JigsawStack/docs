    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the freestanding bell tower of Pisa Cathedral, located behind it in Cathedral Square.",
            "The tower's tilt began in the 12th century due to an inadequate foundation on soft ground.",
            "The tower is approximately 55-57 meters tall, weighs an estimated 14,500 tonnes, and has 294-296 steps."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 86,
            "inference_time_tokens": 1382,
            "total_tokens": 1724
      }
}
    ```
