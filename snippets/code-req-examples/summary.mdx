    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the freestanding bell tower of Pisa Cathedral, located behind the Cathedral and the third-oldest structure in Cathedral Square.",
            "The tower's tilt started in the 12th century during construction due to a soft foundation and increased until stabilization efforts in the late 20th and early 21st centuries.",
            "The tower is approximately 55.86 to 56.67 meters tall, with a base wall width of 2.44 meters, an estimated weight of 14,500 tonnes, and either 296 or 294 steps."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 132,
            "inference_time_tokens": 1600,
            "total_tokens": 1988
      }
}
    ```
