    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the freestanding bell tower of Pisa Cathedral, located behind the Cathedral.",
            "The tower's tilt started in the 12th century during construction due to a weak foundation and soft ground, increasing until stabilization efforts in the late 20th/early 21st centuries.",
            "The tower's height is approximately 55.86-56.67 meters, with a base wall width of 2.44 meters, and it contains 296 or 294 steps."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 114,
            "inference_time_tokens": 1398,
            "total_tokens": 1768
      }
}
    ```
