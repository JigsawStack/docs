    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the freestanding bell tower of Pisa Cathedral, located behind the Cathedral and is the third-oldest structure in the city's Cathedral Square.",
            "The tower's tilt began in the 12th century due to an inadequate foundation on soft ground, increasing until stabilization efforts in the late 20th and early 21st centuries.",
            "The tower's height is approximately 55.86-56.67 meters, with a base wall width of 2.44 meters, an estimated weight of 14,500 tonnes, and either 296 or 294 steps."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 135,
            "inference_time_tokens": 1552,
            "total_tokens": 1943
      }
}
    ```
