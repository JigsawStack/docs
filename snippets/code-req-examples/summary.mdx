    ...
    ```json Response
{
      ...
      "summary": [
            ...
            "The tower's tilt began during construction in the 12th century due to an inadequate foundation on soft ground.",
            "The tower's height is approximately 55.86-56.67 meters, with an estimated weight of 14,500 tonnes, and has 296 or 294 steps."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 102,
            "inference_time_tokens": 1323,
            "total_tokens": 1681
      }
}
    ```
