    ...
    ```json Response
{
      "success": true,
      "summary": [
            "The Leaning Tower of Pisa is the freestanding bell tower of Pisa Cathedral, the third-oldest structure in the city's Cathedral Square.",
            "The tower's tilt started in the 12th century due to a weak foundation on soft ground.",
            "The tower's height is approximately 55.86-56.67 meters, with an estimated weight of 14,500 tonnes, and has 294-296 steps."
      ],
      "_usage": {
            "input_tokens": 256,
            "output_tokens": 95,
            "inference_time_tokens": 1472,
            "total_tokens": 1823
      }
}
    ```
