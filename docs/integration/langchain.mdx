...
LangChain.js now supports calling [JigsawStack Prompt Engine](https://jigsawstack.com/docs/examples/ai/prompt-engine) and more through the JigsawStack Tool.
