...
---
<Update label="18th Feb, 2026" description="API Fixes and Updates" tags={["APIs"]}>
### APIs
- Base64 URLs are no longer counted towards token usage
- Changes to rate limits
  * Free — 50 req/min
  * Pro — 50 req/min (previously 100 req/min)
  * Custom — available on request via support
- **STT**
  * Fixed timestamp millisecond precision
- **OBJECT DETECTION**
  * Handling of invalid & unreachable file added.
