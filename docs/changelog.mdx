...
- **VOCR**
  * Fixed an issue where the API failed when a file URL was provided.
  * Resolved a timeout issue occurring when fine_grained was set to true.

- **Embeddings**
  * Fixed a bug that caused embeddings to time out unexpectedly.

- **AI Scraper**
  * Improved reliability when scraping large websites.
  * Restricted the set of cookies accepted by the scraper for better stability and security.
