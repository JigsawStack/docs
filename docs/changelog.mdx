...
- **VOCR**:
    -  Optimized PDF response times for faster document parsing
- **Speech to Text (STT)**: 
...
- **Speech to Text**:
    - Major boost in diarization performance, now processes up to 5 hours of audio in just 3.5 minutes
- **Translate**:
    - Fixed and improved language detection accuracy 
- **Classification**
