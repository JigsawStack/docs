...
- **Prediction**
   - Improved overall reliability of the Prediction API

- **Speech-to-Text**
   - Added support for Javanese
   - M4a files are now supported

- **VOCR**
   - Resolved an issue where internal guardrail filters were incorrectly blocking valid requests.

- **Translate**
   - Improved error messages for better clarity

- **Log ID**
   - Every request now includes a Request ID to make debugging and tracing issues easier

### INTERFAZE

- Fixed a bug where urls were getting replaced with placeholders. 
- Improved error propagation to provide more clear error details  
