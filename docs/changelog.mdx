...
---
<Update label="September 29, 2025" description="Python v0.3.7, JavaScript v0.3.6" tags={["DOCS", "Fixes", "APIs"]}>

### Fixes
- Fixed Embedding v1 where sometimes the model would fail inconsistently 
