...
<ParamField body="instruction" type="string">
  Instruction for query embedding generation for higher retrival quality, works with type `text` only.
  - Default instruction: `Given a query, retrieve relevant passages that answer the query`
</ParamField>
