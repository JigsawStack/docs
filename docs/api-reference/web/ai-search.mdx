...
<ParamField body="ai_overview" type="boolean" default="false">
...
<ParamField body="auto_scrape" type="boolean" default="true">
...
<ResponseField name="results" type="array">
  ...
  <Expandable title="Result Object Properties">
    ...
    <ResponseField name="content" type="string | object">
      The content of the result, as plain text or structured object.
      
      <Expandable title="Structured Content Object">
    ...
    <ResponseField name="related_index" type="object">
      Array of related search indices.
      
      <Expandable title="RelatedIndex Object Properties">
        <ResponseField name="title" type="string">
          The title of the related search result.
        </ResponseField>
        
        <ResponseField name="url" type="string">
          The URL of the related search result.
        </ResponseField>
        
        <ResponseField name="description" type="string">
          Brief description of the related search result.
        </ResponseField>
...
<ResponseField name="geo_results" type="array">
  ...
  <Expandable title="Geo Result Object Properties">
    ...
    <ResponseField name="geoloc" type="object">
      GeoJSON Point object with "type": "Point" and "coordinates" array containing [longitude, latitude].
