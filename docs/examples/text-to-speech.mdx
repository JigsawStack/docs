...
- Install the [Node.js SDK](https://jigsawstack.com/docs/quick-start/node/introduction)
...
You can provide the key to the audio file stored on the [File Storage API](https://jigsawstack.com/docs/api-reference/store/file/add). Here is an example:
