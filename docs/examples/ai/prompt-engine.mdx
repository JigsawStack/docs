...
- For prompts that will be used multiple times, it is recommended to first [Create](https://jigsawstack.com/docs/api-reference/ai/prompt/create) the prompt and then [Run](https://jigsawstack.com/docs/api-reference/prompt-engine/run) it using the prompt ID for better reliability.
- [Run Prompt Direct](https://jigsawstack.com/docs/api-reference/prompt-engine/run-direct) is ideal for one-time use.

<Info>
  Find more information on Prompt Engine API
  [here](https://jigsawstack.com/docs/api-reference/ai/prompt/create)
</Info>
