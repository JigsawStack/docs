...
To enable webhook for the [Logs API](https://jigsawstack.com/docs/api-reference/logs/create-log), follow the steps below:
...
<Info>
  ...
  Webhook](https://jigsawstack.com/docs/learn/webhook/secure)
</Info>
