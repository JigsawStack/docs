...
1. Creating and running a [reusable prompt](https://jigsawstack.com/docs/examples/ai/prompt-engine#1-create-and-execute-a-reusable-prompt-recommended) (recommended)
2. Executing a [prompt directly](https://jigsawstack.com/docs/examples/ai/prompt-engine#2-executing-the-prompt-directly)
...
<Info>
  ...
  [Create a
  Prompt](https://jigsawstack.com/docs/api-reference/prompt-engine/create) and
  then [Run the
  Prompt](https://jigsawstack.com/docs/api-reference/prompt-engine/run)
</Info>
